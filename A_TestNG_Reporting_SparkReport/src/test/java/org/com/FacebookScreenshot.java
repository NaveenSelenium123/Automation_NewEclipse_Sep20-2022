...
public void tc3() throws IOException {
	...
	ExtentTest eTest2=extent.createTest("TestOne","This test is shows image");
	 eTest2.log(Status.FAIL,"TestOne Started");
	 eTest2.addScreenCaptureFromPath( takesScreenshotAndReturnPath("HPSearch"),"HPProductSearch");
	extent.flush();
