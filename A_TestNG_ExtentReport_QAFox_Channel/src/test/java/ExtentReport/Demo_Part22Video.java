...
eTest1.log(Status.INFO, MediaEntityBuilder.createScreenCaptureFromBase64String(takeScreenshot(),"TutorialNinja Home page").build());



driver.findElement(By.name("search")).sendKeys("HP");
eTest1.log(Status.INFO,"hp product name entered in the text box");
eTest1.log(Status.INFO, MediaEntityBuilder.createScreenCaptureFromPath(takesScreenshotAndReturnPath("HPSearch"),"HPProductSearch").build());
extent.flush();
