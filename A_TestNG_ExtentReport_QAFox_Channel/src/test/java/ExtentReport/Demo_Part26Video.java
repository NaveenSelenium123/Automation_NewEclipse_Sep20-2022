...
public class Demo_Part26Video {
public static void main(String[] args) throws IOException {
	ExtentReports extent=new ExtentReports();
	File file=new File(System.getProperty("user.dir")+"\\ExtentReport\\eReport.html");
ExtentSparkReporter sparkReporter=new ExtentSparkReporter(file);
//sparkReporter.loadJSONConfig(new File(System.getProperty("user.dir")+"\\src\\test\\resources\\extent-reports-config-json"));
sparkReporter.loadXMLConfig(new File(System.getProperty("user.dir")+"\\src\\test\\resources\\extent-reports-config-xml"));
